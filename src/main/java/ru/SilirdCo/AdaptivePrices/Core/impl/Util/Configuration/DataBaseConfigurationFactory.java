package ru.SilirdCo.AdaptivePrices.Core.impl.Util.Configuration;
...
public class DataBaseConfigurationFactory {
    ...
    private ApplicationContext context = new FileSystemXmlApplicationContext("/Configuration/DataBaseConfiguration.xml");
            ...
            if (!file.exists()) {
                ...
                try (PrintWriter out = new PrintWriter(new OutputStreamWriter(new FileOutputStream(file.getAbsoluteFile()), StandardCharsets.UTF_8))) {
                    ...
                    out.print("<beans xmlns=\"http://www.springframework.org/schema/beans\"\n" +
                            ...
                            "\n" +
                            "    <bean id=\"dataBaseConfiguration\" class=\"ru.SilirdCo.AdaptivePrices.Core.impl.Util.Configuration.DataBaseConfiguration\" scope=\"prototype\">\n" +
